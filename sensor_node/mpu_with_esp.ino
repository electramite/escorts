...
void loop() {
   ...
   Serial.print((AcX/16384.0)); Serial.print(" , ");
   Serial.print((AcY/16384.0)); Serial.print(" , ");
   Serial.print((AcZ/16384.0)); Serial.print(" , ");
   Serial.print(v_pitch); Serial.print(" , ");
   Serial.print(v_roll); Serial.print(" , ");
   Serial.print(v_yaw); Serial.print("\n");
