...
int sensorPin = 33; // select the input pin for the potentiometer (NOTE:- you can't use adc2 pins for sensors while using wifi library)
int sensorValue = 0;
float i = 0;
float fixtemp = 20.;
int fixInput = 560;
